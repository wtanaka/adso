...
Cun01::Cun01(Text *t): Geography(t) { myclass += ":Cun01"; };
Cun01::~Cun01() {}

int Cun01::unify(Text *t, int a, int b, int c) {
  ...
  if (generate_name == 1) {
	english = generate_village_name() + " village";
  }
...
std::string Cun01::generate_village_name() {
