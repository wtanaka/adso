...
class Db40 {
	...
	const char * table_792[26][11];
	const char * table_793[15][11];
	const char * table_794[22][11];
	const char * table_795[8][11];
	const char * table_796[5][11];
	const char * table_797[55][11];
	const char * table_798[11][11];
	const char * table_799[9][11];
	const char * table_800[13][11];
