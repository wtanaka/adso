...
Xian01::Xian01(Text *t): Special(t) { myclass += ":Xian01";};
Xian01::~Xian01() {}


int Xian01::unify(Text *t, int a, int b, int c) {
  ...
  if (generate_name == 1) {
	english = generate_county_name() + " county";
  }
...
std::string Xian01::generate_county_name() {
